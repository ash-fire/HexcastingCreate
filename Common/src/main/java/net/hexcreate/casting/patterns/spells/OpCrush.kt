...
import at.petrak.hexcasting.datagen.recipe.builders.CreateCrushingRecipeBuilder.CrushingRecipe
...
class OpCrush : SpellAction {
    ...
    private data class Spell(val target: ItemEntity) : RenderedSpell {
        override fun cast(ctx: CastingContext) {
            ...
            Registry.RECIPE_TYPE.get(ResourceLocation("create", "crushing"))
