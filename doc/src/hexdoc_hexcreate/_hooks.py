...
import hexdoc_hexcreate

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class HexcreatePlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return HexcreateModPlugin(branch=branch)


class HexcreateModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "hexcreate"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_hexcreate, "_templates"
